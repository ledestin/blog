...
## Trying "Atomic Habits" (Motivating myself with rewards)
...
Rewarding myself worked, but this time, I had a different pain. Instead of the pain of starting to clean my face, I had the pain of starting to read the motivational note. That's the problem with [just do it](https://www.youtube.com/watch?v=ZXsQAXx_ao0), pain doesn't go away. Eventually, I forgot about those notes, and stopped reading them. No wonder, what is painful, doesn't stick.
...
## Trying "Doing Time Right" (Reframe YouTube as harmful)

In July, having no success with [Atomic Habits](https://www.goodreads.com/book/show/40121378-atomic-habits), I bought [Unlocking Hidden Hours: Doing Time Right](https://stephsmithio.gumroad.com/l/doing-time-right). It's a productivity book from an outstanding writer [Steph Smith](https://stephsmith.io/).
...
It was an interesting take, trying to fix the bug by making YouTube painful. **Maybe, I was lucky it didn't work out.** God knows what addiction I'd gravitate towards instead of YouTube. An eating addiction? Shopping? I wouldn't gravitate towards painful wholesome things, but towards lack of pain.
...
In August, I still wanted to get out of my YouTube addiction. I read [Mind Management, Not Time Management](https://kadavy.net/mind-management-not-time-management/).
...
I got the book's highlights into my [Second Brain](https://fortelabs.co/blog/basboverview/) and kept re-reading them, mainly because I loved reading them. At first, nothing happened, but I kept re-reading.

By ~9th re-reading, things started to happen.

I was working on a project of adding a YAML config interface to a [CLI program](https://github.com/kasmtech/KasmVNC). I had done two [pomodoro](https://francescocirillo.com/pages/pomodoro-technique) of inventing YAML config vocabulary, had dinner, and didn't feel like doing that anymore. I felt like immersing myself in a topic. According to the book, inventing vocabulary and immersing oneself in a topic are different mental states, Generate and Explore, respectively. So, I looked for a work task matching Explore, and there was one! The task was figuring out how to write tests for YAML -> CLI conversion. Figuring that out was necessary because I didn't want to use the language the program was written in (Perl). I wanted to write tests in a more convenient language (Python). I found an RSpec-like test framework for Python, and added `-dry-run` flag that prints generated command.

It felt wonderful, easy and fun. I **didn't force myself** to do the task I didn't want, and I **still got important work done**!

I started to decide what to do next based on my mental state. Having that as a starting point helped with my YouTube addiction a bit. Now, there were some **wholesome options that I looked forward to:**
...
In October 2021, by recommendation of my favourite YouTuber [Elizabeth Filips](https://www.elizabethfilips.com/) , I subscribed to [Curiosity Stream](https://curiositystream.com) . I started watching much less YouTube politics and music videos, and much more history and science videos.
...
Despite good things happening, my life was still **terrible**.
...
punched in the gut. And, I forced myself to do things all the time. For
example, if I wanted to read a book, I'd instead do something I didn't want to
do, like reading email. Because, reading email was **productive**, and reading a
book wasn't.

And then, my favourite YouTuber said that
**doing only what I want** [was
...
## Want to follow your passion too?
